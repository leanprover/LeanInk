...
def genFragment (annotation : Compound Tactic) (contents : String) : Alectryon.Fragment :=
...
-/
def annotateFileWithCompounds (l : List Alectryon.Fragment) (contents : String) : List (Compound Tactic) -> IO (List Fragment)
| [] => pure l
| [x] => do
...
def genOutput (file : System.FilePath) (contents : String) (annotation : List (Compound Tactic)) : IO UInt32 := do
