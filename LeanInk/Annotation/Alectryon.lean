...
def genFragment (annotation : Compound TacticFragment) (contents : String) : Alectryon.Fragment :=
...
-/
def annotateFileWithCompounds (l : List Alectryon.Fragment) (contents : String) : List (Compound TacticFragment) -> IO (List Fragment)
| [] => pure l
| [x] => do
